...
// ---------- 加载配置数据 ----------
const realms = (await import('./src/data/realms.js')).default;
const methods = (await import('./src/data/methods.js')).default;
const dungeon = (await import('./src/data/dungeon.js')).default;
const events = (await import('./src/data/events.js')).default;
